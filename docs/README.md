...
- [`AGENTS.md`](../AGENTS.md): 프로젝트 구조와 AI 작업 규칙
- [`LAYOUT_CONTRACT.md`](../LAYOUT_CONTRACT.md): UI 레이아웃 불변 조건
- [`ROUTE_CREATION_GUIDE.md`](../ROUTE_CREATION_GUIDE.md): 백엔드 API 추가 절차
- [`POST_RELEASE_MAINTENANCE_GUIDE.md`](../POST_RELEASE_MAINTENANCE_GUIDE.md): 배포 후 유지보수 원칙
- [`GOOGLE_ACCOUNT_MIGRATION_GUIDE.md`](../GOOGLE_ACCOUNT_MIGRATION_GUIDE.md): Google/Firebase 계정 교체
- [`DEV_RULE_CHECKLIST.md`](../DEV_RULE_CHECKLIST.md): 작업 전후 확인 목록

완료된 개별 계획서와 중간 보고서는 개발 히스토리에 통합하고 별도 파일로 유지하지 않습니다.
