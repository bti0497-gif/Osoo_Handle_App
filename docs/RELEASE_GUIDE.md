...
gh release create 1.0.3 `
  "release/auto-update-v1.0.3/Osoo-Handle-App-Setup-1.0.3.exe" `
  "release/auto-update-v1.0.3/Osoo-Handle-App-Setup-1.0.3.exe.blockmap" `
  "release/auto-update-v1.0.3/latest.yml" `
  --repo bti0497-gif/Osoo_Handle_App `
  --title "Osoo Handle App 1.0.3" `
  --notes-file "release/auto-update-v1.0.3/release-notes.md"
```
...
```powershell
gh release view 1.0.3 --repo bti0497-gif/Osoo_Handle_App
```
