...
const DataGrid = ({
    ...
    return (
        <div className="panel-container justify-center">
            <div className="dynamic-panel shadow-2xl border-slate-200" style={{ width: width, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                            ...
                            {columns.map(c => {
                                ...
                                return (
                                    <div key={c.id} style={{ display: 'flex', flexDirection: 'column', borderRight: '1px solid #1e3a8a', boxSizing: 'border-box' }}>
                                        <div style={{ height: 26, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 900, color: baseColor, backgroundColor: baseBg, borderBottom: '1px solid rgba(0,0,0,0.1)', boxSizing: 'border-box' }}>
                                            {c.label}
                                        </div>
                                                ...
                                                {c.subCols.map((sc, i) => {
                                                    ...
                                                    return (
                                                        <div key={sc.id}
                                                            ...
                                                            style={{ width: sc.width || 60, flexShrink: 0, borderRight: i === c.subCols.length - 1 ? 'none' : '1px solid #e2e8f0', boxSizing: 'border-box', display: 'flex', alignItems: 'center', position: 'relative', background: (isHovered && isColHovered) ? 'var(--hover-cell-bg, rgba(0,0,0,0.05))' : isColHovered ? 'var(--hover-col-bg, rgba(0,0,0,0.02))' : 'transparent' }}>
