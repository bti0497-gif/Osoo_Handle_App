                            ...
                            <form onSubmit={handleSubmit}>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                        ...
                                        <div>
                                            <label style={{ display: 'block', fontSize: '0.6875rem', fontWeight: 800, color: '#94a3b8', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>회원 권한 설정</label>
                                            <div
                                                style={{ width: '100%', border: '2px solid #1e293b', height: '40px', padding: '0 12px', fontWeight: 700, color: '#1e293b', display: 'flex', alignItems: 'center', backgroundColor: 'white' }}
                                            >
                                                <input
                                                    type="checkbox"
                                                    id="roleCheckbox"
                                                    checked={form.role === 'admin'}
                                                    onChange={e => updateForm({ role: e.target.checked ? 'admin' : 'group_admin' })}
                                                    style={{ marginRight: '8px', cursor: 'pointer' }}
                                                />
                                                <label htmlFor="roleCheckbox" style={{ cursor: 'pointer', fontSize: '0.875rem' }}>
                                                    {form.role === 'admin' ? '현장관리자' : '권역통합관리자'}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
