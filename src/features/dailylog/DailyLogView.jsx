...
const DailyLogView = ({ currentUser, templateName = '수질분석일지', title = '수질분석일지' }) => {
    ...
    useEffect(() => {
        if (!['REPORT_TEMPLATE_MISSING', 'REPORT_HWP_TEMPLATE_MISSING', 'REPORT_HWPX_TEMPLATE_MISSING'].includes(manifestErrorCode) || !manifestError) {
            return;
        }
