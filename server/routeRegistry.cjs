...
const routeRegistry = [
  ...
  { tier: 1, path: '/',                   module: './routes/waterQualityRoutes.cjs',   args: ['db', 'BASE_DIR', 'appDataPath'], watch: true },
  ...
  { tier: 1, path: '/',                   module: './routes/equipmentRoutes.cjs',      args: ['db', 'appDataPath'], watch: true },
