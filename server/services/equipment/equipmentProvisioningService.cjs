...
const COMMON_DEFS = () => [
  ...
  ...unitCards(null, '포기조', '브로아류', '포기조브로아', { managementNoBase: 'M-105', model: '루츠 블로어', power: '7.5 kW', location: '송풍기실', accessory: '공기 여과기 포함', notes: '기본 2대 · 추가 시 C, D, E...' }),
  ...unitCards(null, '포기조', '펌프류', '내부반송펌프', { managementNoBase: 'M-106', model: '수중펌프', power: '2.2 kW', notes: '기본 2대 · 추가 시 C, D, E...' }),
