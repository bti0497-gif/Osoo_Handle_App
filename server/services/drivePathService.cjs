 ...
 *     │
 *     ├── 약품입고/                 ← 약품입고일지 사진 (향후 구현)
 *     │   └── {year}/
 *     │       └── {month}/
 *     │           └── {date}/
 *     │               └── {date}-{약품명}.jpg
 *     │                   예) 2026-04-01-PAC.jpg
 *     │                   예) 2026-04-01-PAC-2.jpg  (같은 날 동일 약품 여러 장)
 *     │
 *     └── 슬러지/                   ← 슬러지사진대지 사진 (향후 구현)
 *         └── {year}/
 *             └── {month}/
 *                 └── {date}/
 *                     └── {date}-슬러지-{번호}.jpg
 *                         예) 2026-04-01-슬러지-1.jpg
 *
 * ─────────────────────────────────────────────────────────────────────
 * 사용 방법 (예시)
 * ─────────────────────────────────────────────────────────────────────
...
/**
 * 약품입고 사진 폴더 (현장 업로드) — 향후 구현
 * → ROOT/{현장명}/약품입고/{year}/{month}/{date}/
 * @param {string} siteName  현장명
 * @param {string} date      'YYYY-MM-DD' 형식
 */
...
/**
 * 슬러지 사진 폴더 (현장 업로드) — 향후 구현
 * → ROOT/{현장명}/슬러지/{year}/{month}/{date}/
 * @param {string} siteName  현장명
 * @param {string} date      'YYYY-MM-DD' 형식
 */
